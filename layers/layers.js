...
lyr_ESRI_0.setVisible(true);lyr_SriLankaDistricts_1.setVisible(true);lyr_SriLankaRoads_2.setVisible(true);lyr_SriLankaWaterways_3.setVisible(true);
var layersList = [lyr_ESRI_0,lyr_SriLankaDistricts_1,lyr_SriLankaRoads_2,lyr_SriLankaWaterways_3];
...
lyr_SriLankaDistricts_1.set('fieldLabels', {'shapeName': 'no label', 'shapeISO': 'inline label - visible with data', 'shapeID': 'no label', 'shapeGroup': 'no label', 'shapeType': 'no label', });
